...
#include "source/extensions/filters/http/rider/context.h"

#include "envoy/extensions/filters/http/rider/v3alpha1/rider.pb.h"
...
public:
  ...
  virtual std::unique_ptr<Coroutine> createCoroutine() { PANIC_DUE_TO_CORRUPT_ENUM; };
